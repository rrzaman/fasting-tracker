...
- **Health Trend Analysis** *(in progress)* — Correlates fasting days with health metrics to surface trends across fasting vs. non-fasting conditions.
- **Personal Dashboard** *(in progress)* — React-based web interface for viewing calendar, health correlations, and managing fasting overrides.

## Architecture
The project is structured in four layers:

**Layer 1 — Data Ingestion** *(local Python scripts)*
...
**Layer 2 — Cloud Storage** *(AWS S3 + DynamoDB)*
...
**Layer 3 — Automation** *(AWS Lambda + EventBridge)*
...
**Layer 4 — Dashboard** *(React, hosted on S3)* *(in progress)*
...
## Roadmap
- **May 2026:** Lambda deployment, automated SMS reminder system, initial AWS infrastructure
- **June 2026:** React dashboard with fasting calendar view and health trend correlations
- **June 2026:** AWS Cognito authentication to protect personal health data
- **July 2026:** Deeper health analytics. Heart rate variability, sleep stage breakdown during fasting, focus on fasting hours (Fajr to Maghrib).
